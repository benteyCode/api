...
/**
 * @author yy
 * @time 2017/2/24 11:12
 * @desc ${TODO}
 */

public class DeblockConverterFactory extends Converter.Factory {
    ...
    private final UpLoad callback;

    public DeblockConverterFactory(RequestBody requestBody, UpLoad listener) {
                    ...
                    private Sink sink(Sink sink) {
                        return new ForwardingSink(sink) {
                            ...
                            public void write(Buffer source, long byteCount) throws IOException {
                                ...
                                //回调
                                callback.onProgress(bytesWritten, contentLength, bytesWritten == contentLength);
                            }
                        };
                    }
                };
